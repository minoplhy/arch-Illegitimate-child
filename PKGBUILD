...
arch=('i686' 'x86_64')
license=('LGPL')
makedepends=('glib2' 'libxml2' 'libproxy' 'sqlite3' 'gconf'
             'libgnome-keyring' 'intltool' 'gobject-introspection' 'glib-networking')
url="http://www.gnome.org"
source=(http://ftp.gnome.org/pub/gnome/sources/${pkgbase}/${pkgver%.*}/${pkgbase}-${pkgver}.tar.bz2)
options=('!libtool' '!emptydirs')
sha256sums=('4780eff65a6ee42ac9bc35871cfab441ae076c5f23c02773768197c4cd720eec')
...
package_libsoup-gnome() {
  ...
  depends=("libsoup=${pkgver}" 'libproxy' 'libgnome-keyring' 'gconf')
