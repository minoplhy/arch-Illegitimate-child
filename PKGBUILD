...
arch=('i686' 'x86_64')
license=('LGPL')
makedepends=('glib2>=2.24.1' 'gnutls>=2.8.6' 'libxml2>=2.7.7' 'libproxy>=0.4.6' 'sqlite3>=3.6.23' 'gconf>=2.28.1' 'libgnome-keyring>=2.30.1' 'intltool' 'pkg-config' 'gobject-introspection>=0.6.14')
...
package_libsoup-gnome() {
  ...
  depends=("libsoup=${pkgver}" 'libproxy>=0.4.6' 'libgnome-keyring>=2.30.1' 'gconf>=2.28.1')
