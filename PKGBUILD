...
#  2. just run the above 'fusermount3' command (doing this might leave redundant
...
makedepends=(udisks2 p7zip httpdirfs fuse3 udftools)
...
_sha256sums=('74d696e666f696e93db685a85c94bfbfcc0796dfcf8a2e2e2e2c908a54e82949'
